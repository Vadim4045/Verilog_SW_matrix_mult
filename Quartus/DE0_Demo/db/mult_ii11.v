...
module  mult_ii11
	...
	assign
		wire_sft10a_in = {w177w, {w177w, {w177w, {w177w, {w177w, {w177w, {w177w, {2{w177w}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft3a_in = {w177w, {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[35], {w_sum_node10w[34], {w_sum_node10w[43], {w_sum_node10w[42], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w177w, {w177w, {w177w, {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15], {w_sum_node10w[14], {w_sum_node10w[13:12]}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w177w, {w177w, {w177w, {w177w, {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[25], {w_sum_node10w[24], {2{w177w}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w177w, {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[41], {w_sum_node10w[40], {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[37:36]}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w177w, {w177w, {w177w, {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[29], {w_sum_node10w[28], {w_sum_node10w[27:26]}}}}}}}};
	assign
		dataa_node = {dataa[9:0]},
		datab_node = {datab[7:0]},
		final_result_node = {w282w[17:0]},
		result = {final_result_node[17:0]},
		w177w = 1'b0,
		w282w = {wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[9:0]} & {10{w_le_datab_node8w[7]}}), ({dataa_node[9:0]} & {10{w_le_datab_node8w[6]}}), ({dataa_node[9:0]} & {10{w_le_datab_node8w[5]}}), ({dataa_node[9:0]} & {10{w_le_datab_node8w[4]}}), ({dataa_node[9:0]} & {10{w_le_datab_node8w[3]}}), ({dataa_node[9:0]} & {10{w_le_datab_node8w[2]}}), ({dataa_node[9:0]} & {10{w_le_datab_node8w[1]}}), ({dataa_node[9:0]} & {10{w_le_datab_node8w[0]}})},
