...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTH=21 dataa datab result
...
module  mult_ji11
	...
	assign
		wire_sum_adder1aa_0dataa = {1'b0, w_decoder_node9w[39:20]},
		wire_sum_adder1aa_0datab = {{2{1'b0}}, w_decoder_node9w[19:1]};
	assign
		wire_sum_adder1aa_1result = wire_sum_adder1aa_1dataa + wire_sum_adder1aa_1datab;
	assign
		wire_sum_adder1aa_1dataa = {1'b0, w_decoder_node9w[79:60]},
		wire_sum_adder1aa_1datab = {{2{1'b0}}, w_decoder_node9w[59:41]};
	assign
		wire_sum_adder1aa_2result = wire_sum_adder1aa_2dataa + wire_sum_adder1aa_2datab;
	assign
		wire_sum_adder1aa_2dataa = {1'b0, w_decoder_node9w[119:100]},
		wire_sum_adder1aa_2datab = {{2{1'b0}}, w_decoder_node9w[99:81]};
	assign
		wire_sum_adder1aa_3result = wire_sum_adder1aa_3dataa + wire_sum_adder1aa_3datab;
	assign
		wire_sum_adder1aa_3dataa = {1'b0, w_decoder_node9w[159:140]},
		wire_sum_adder1aa_3datab = {{2{1'b0}}, w_decoder_node9w[139:121]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w237w, {w237w, {w237w, {w237w, {w237w, {w237w, {w237w, {w237w, {w237w, {w237w, {w237w, {w237w, {w237w, {w237w, {w237w, {w237w, {w237w, {2{w237w}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft9a_in = {w237w, {w237w, {w237w, {w_sum_node10w[61], {w_sum_node10w[60], {w_sum_node10w[59], {w_sum_node10w[58], {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47:46]}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {dataa[19:0]},
		datab_node = {datab[7:0]},
		final_result_node = {w422w[27:0]},
		result = {final_result_node[27:0]},
		w237w = 1'b0,
		w422w = {wire_sft6a_out[26:25], wire_sft6a_out[24:23], wire_sft6a_out[22:21], wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[19:0]} & {20{w_le_datab_node8w[7]}}), ({dataa_node[19:0]} & {20{w_le_datab_node8w[6]}}), ({dataa_node[19:0]} & {20{w_le_datab_node8w[5]}}), ({dataa_node[19:0]} & {20{w_le_datab_node8w[4]}}), ({dataa_node[19:0]} & {20{w_le_datab_node8w[3]}}), ({dataa_node[19:0]} & {20{w_le_datab_node8w[2]}}), ({dataa_node[19:0]} & {20{w_le_datab_node8w[1]}}), ({dataa_node[19:0]} & {20{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[7:0]},
		w_sum_node10w = {wire_sum_adder1aa_3result[20:0], w_decoder_node9w[120], wire_sum_adder1aa_2result[20:0], w_decoder_node9w[80], wire_sum_adder1aa_1result[20:0], w_decoder_node9w[40], wire_sum_adder1aa_0result[20:0], w_decoder_node9w[0]};
endmodule //mult_ji11
//VALID FILE
