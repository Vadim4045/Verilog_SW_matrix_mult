//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Logic ELements" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=13 LPM_WIDTHB=8 LPM_WIDTHP=21 LPM_WIDTHS=1 MAXIMIZE_SPEED=6 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTH=14 dataa datab result
...
module  mult_fi11
	...
	assign
		wire_sum_adder1aa_0dataa = {1'b0, w_decoder_node9w[25:13]},
		wire_sum_adder1aa_0datab = {{2{1'b0}}, w_decoder_node9w[12:1]};
	assign
		wire_sum_adder1aa_1result = wire_sum_adder1aa_1dataa + wire_sum_adder1aa_1datab;
	assign
		wire_sum_adder1aa_1dataa = {1'b0, w_decoder_node9w[51:39]},
		wire_sum_adder1aa_1datab = {{2{1'b0}}, w_decoder_node9w[38:27]};
	assign
		wire_sum_adder1aa_2result = wire_sum_adder1aa_2dataa + wire_sum_adder1aa_2datab;
	assign
		wire_sum_adder1aa_2dataa = {1'b0, w_decoder_node9w[77:65]},
		wire_sum_adder1aa_2datab = {{2{1'b0}}, w_decoder_node9w[64:53]};
	assign
		wire_sum_adder1aa_3result = wire_sum_adder1aa_3dataa + wire_sum_adder1aa_3datab;
	assign
		wire_sum_adder1aa_3dataa = {1'b0, w_decoder_node9w[103:91]},
		wire_sum_adder1aa_3datab = {{2{1'b0}}, w_decoder_node9w[90:79]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w195w, {w195w, {w195w, {w195w, {w195w, {w195w, {w195w, {w195w, {w195w, {w195w, {2{w195w}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft3a_in = {w195w, {w_sum_node10w[59], {w_sum_node10w[58], {w_sum_node10w[44], {w_sum_node10w[43], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[14], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft5a_in = {w195w, {w195w, {w195w, {w195w, {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[31], {w_sum_node10w[30], {2{w195w}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w195w, {w_sum_node10w[29], {w_sum_node10w[28], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46:45]}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w195w, {w195w, {w195w, {w_sum_node10w[40], {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[35], {w_sum_node10w[34], {w_sum_node10w[33:32]}}}}}}}}}}};
	assign
		dataa_node = {dataa[12:0]},
		datab_node = {datab[7:0]},
		final_result_node = {w324w[20:0]},
		result = {final_result_node[20:0]},
		w195w = 1'b0,
		w324w = {wire_sft6a_out[19:18], wire_sft6a_out[17:16], wire_sft6a_out[15:14], wire_sft6a_out[13:12], wire_sft6a_out[11:10], wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[12:0]} & {13{w_le_datab_node8w[7]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[6]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[5]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[4]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[3]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[2]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[1]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[7:0]},
		w_sum_node10w = {wire_sum_adder1aa_3result[13:0], w_decoder_node9w[78], wire_sum_adder1aa_2result[13:0], w_decoder_node9w[52], wire_sum_adder1aa_1result[13:0], w_decoder_node9w[26], wire_sum_adder1aa_0result[13:0], w_decoder_node9w[0]};
endmodule //mult_fi11
//VALID FILE
