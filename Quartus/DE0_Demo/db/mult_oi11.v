...
module  mult_oi11
	...
	wire  [33:0]   wire_sft6a_in;
	wire  [33:0]   wire_sft6a_out;
	...
	wire  [7:0]  datab_node;
	wire  [34:0]  final_result_node;
	wire  w279w;
	wire  [35:0]  w520w;
	wire  [215:0]  w_decoder_node9w;
	wire  [7:0]  w_le_datab_node8w;
	wire  [115:0]  w_sum_node10w;
	...
	assign
		wire_sft10a_in = {w279w, {w279w, {w279w, {w279w, {w279w, {w279w, {w279w, {w279w, {w279w, {w279w, {w279w, {w279w, {w279w, {w279w, {w279w, {w279w, {w279w, {w279w, {w279w, {w279w, {w279w, {w279w, {w279w, {w279w, {2{w279w}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft8a_in = {w279w, {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[109], {w_sum_node10w[108], {w_sum_node10w[107], {w_sum_node10w[106], {w_sum_node10w[105], {w_sum_node10w[104], {w_sum_node10w[103], {w_sum_node10w[102], {w_sum_node10w[101], {w_sum_node10w[100], {w_sum_node10w[99], {w_sum_node10w[98], {w_sum_node10w[97], {w_sum_node10w[96], {w_sum_node10w[95], {w_sum_node10w[94], {w_sum_node10w[93], {w_sum_node10w[92], {w_sum_node10w[91], {w_sum_node10w[90], {w_sum_node10w[89], {w_sum_node10w[88:87]}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w279w, {w279w, {w279w, {w_sum_node10w[82], {w_sum_node10w[81], {w_sum_node10w[80], {w_sum_node10w[79], {w_sum_node10w[78], {w_sum_node10w[77], {w_sum_node10w[76], {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[71], {w_sum_node10w[70], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[64], {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[61:60]}}}}}}}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {dataa[26:0]},
		datab_node = {datab[7:0]},
		final_result_node = {w520w[34:0]},
		result = {final_result_node[34:0]},
		w279w = 1'b0,
		w520w = {wire_sft6a_out[33:32], wire_sft6a_out[31:30], wire_sft6a_out[29:28], wire_sft6a_out[27:26], wire_sft6a_out[25:24], wire_sft6a_out[23:22], wire_sft6a_out[21:20], wire_sft6a_out[19:18], wire_sft6a_out[17:16], wire_sft6a_out[15:14], wire_sft6a_out[13:12], wire_sft6a_out[11:10], wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[26:0]} & {27{w_le_datab_node8w[7]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[6]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[5]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[4]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[3]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[2]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[1]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[7:0]},
		w_sum_node10w = {wire_sum_adder1aa_3result[27:0], w_decoder_node9w[162], wire_sum_adder1aa_2result[27:0], w_decoder_node9w[108], wire_sum_adder1aa_1result[27:0], w_decoder_node9w[54], wire_sum_adder1aa_0result[27:0], w_decoder_node9w[0]};
endmodule //mult_oi11
//VALID FILE
