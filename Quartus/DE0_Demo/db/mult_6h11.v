...
module  mult_6h11
	...
	wire  [6:0]   wire_sft8a_in;
	wire  [6:0]   wire_sft8a_out;
	wire  [6:0]   wire_sft9a_in;
	wire  [6:0]   wire_sft9a_out;
	wire  [7:0]  dataa_node;
	wire  [7:0]  datab_node;
	...
	assign
		wire_sum_adder1aa_3dataa = {1'b0, w_decoder_node9w[63:56]},
		wire_sum_adder1aa_3datab = {{2{1'b0}}, w_decoder_node9w[55:49]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w165w, {w165w, {w165w, {w165w, {w165w, {2{w165w}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft3a_in = {w165w, {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[29], {w_sum_node10w[28], {w_sum_node10w[35], {w_sum_node10w[34], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w165w, {w165w, {w165w, {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[27], {w_sum_node10w[26], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15], {w_sum_node10w[14], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11:10]}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w165w, {w165w, {w165w, {w165w, {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[21], {w_sum_node10w[20], {2{w165w}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w165w, {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31:30]}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w165w, {w165w, {w165w, {w_sum_node10w[25], {w_sum_node10w[24], {w_sum_node10w[23:22]}}}}}};
	assign
		dataa_node = {dataa[7:0]},
		datab_node = {datab[7:0]},
		final_result_node = {w254w[15:0]},
		result = {final_result_node[15:0]},
		w165w = 1'b0,
		w254w = {wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
